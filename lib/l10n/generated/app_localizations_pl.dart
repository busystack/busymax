...
class AppLocalizationsPl extends AppLocalizations {
  ...
  String repeatOnOrdinalSummary(String position, String days) {
    String _temp0 = intl.Intl.selectLogic(position, {
      ...
      'fourth': '4. $days',
      'fifth': '5. $days',
      'secondToLast': '$days (przedostatnie wystąpienie)',
      'last': '$days (ostatnie wystąpienie)',
      'other': '$days',
    });
    return '$_temp0';
  }
  ...
  @override
  String get notificationDismissAction => 'Odrzuć';
  ...
  String repeatYearlyOnOrdinalSummary(
    ...
    String _temp0 = intl.Intl.selectLogic(position, {
      ...
      'fourth': '4. $days $month',
      'fifth': '5. $days $month',
      'secondToLast': '$days (przedostatnie wystąpienie w miesiącu: $month)',
      'last': '$days (ostatnie wystąpienie w miesiącu: $month)',
      'other': '$days $month',
    });
