  ...
  test('sends application-wide state to the native headerbar', () async {
    ...
    await service.setTheme(
      const BusyMaxHeaderBarTheme(
        ...
        dialogCancelBackgroundColor: Color.fromRGBO(255, 255, 255, 0.10),
        dialogCancelHoverColor: Color.fromRGBO(255, 255, 255, 0.14),
        dialogCancelActiveColor: Color.fromRGBO(255, 255, 255, 0.18),
        dialogDestructiveBackgroundColor: Color(0xFFE01B24),
        dialogDestructiveHoverColor: Color(0xFFE22D36),
        dialogDestructiveActiveColor: Color(0xFFE4363E),
        dialogDestructiveForegroundColor: Color(0xFFFFFFFF),
    ...
    expect(
      ...
      equals({
        ...
        'dialogCancelBackgroundColor': 'rgba(255,255,255,0.10)',
        'dialogCancelHoverColor': 'rgba(255,255,255,0.14)',
        'dialogCancelActiveColor': 'rgba(255,255,255,0.18)',
        'dialogDestructiveBackgroundColor': '#E01B24',
        'dialogDestructiveHoverColor': '#E22D36',
        'dialogDestructiveActiveColor': '#E4363E',
        'dialogDestructiveForegroundColor': '#FFFFFF',
