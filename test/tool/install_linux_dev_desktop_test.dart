...
void main() {
  group('install_linux_dev_desktop.sh', () {
    test('installs an idempotent Wayland desktop registration', () async {
      ...
      expect(desktopContents, contains('StartupWMClass=io.busystack.busymax'));
    ...
    test('does not overwrite a desktop entry it does not own', () async {
      final dataHome = await Directory.systemTemp.createTemp(
