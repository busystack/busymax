...
if ($flutterVersion -ne '3.47.4') {
  throw "BusyMax requires Flutter 3.47.4; found $flutterVersion."
}
if ($dartVersion -ne '3.13.3') {
  throw "Flutter 3.47.4 must provide Dart 3.13.3; found $dartVersion."
}
